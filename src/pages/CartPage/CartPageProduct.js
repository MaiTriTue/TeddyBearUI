    ...
    return (
        <div className={cx('cart_product')}>
            ...
            <div className={cx('cart_product-img')}>
                <img src={cartProduct[cartProductIndex].icon} alt={cartProduct[cartProductIndex].name} />
            </div>
                ...
                <div className={cx('cart_product-info-price')}>
                    <span>
                        {isNaN(cartProduct[cartProductIndex].price)
                            ? 'LIÊN HỆ'
                            : cartProduct[cartProductIndex].price * cartProduct[cartProductIndex].count + ' VND'}
                    </span>
                </div>
            </div>
